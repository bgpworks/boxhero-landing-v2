...
- **El método de agregación predeterminado** también se puede configurar por separado.<br/><gray-text>(Actualmente solo los tipos de fórmulas numéricas pueden cambiar el método de agregación.)</gray-text>
