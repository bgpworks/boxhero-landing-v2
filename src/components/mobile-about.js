...
const Top = ({ data }) => (
  ...
  >
    <Container320 className={styles.topContentContainer}>
      ...
      <Padding y={30} />
      <TransitionImage
        item={<Img fixed={data.mobileTopLogo.childImageSharp.fixed} />}
      />
    </Container320>
  </BackgroundImage>
)
  ...
  <Container320>
    <div className={styles.section}>
      <div className={styles.title}>
        <TransitionUp item={<Trans i18nKey="about:strongPoint1Title" />} />
      </div>
      <div className={styles.desc}>
        <TransitionUp item={<Trans i18nKey="about:strongPoint1DescMobile" />} />
      </div>
      <div className={styles.logoContainer}>
        <TransitionImage
          item={<Img fixed={data.mobileEasy.childImageSharp.fixed} />}
        />
      </div>
    </div>
    ...
    <div className={styles.section}>
      <div className={styles.title}>
        <TransitionUp
          item={<Trans i18nKey="about:strongPoint2TitleMobile" />}
        />
      </div>
      <div className={styles.desc}>
        <TransitionUp item={<Trans i18nKey="about:strongPoint2DescMobile" />} />
      </div>
      <div className={styles.logoContainer}>
        <TransitionImage
          item={<Img fixed={data.mobileGreat.childImageSharp.fixed} />}
        />
      </div>
    </div>
    <div className={styles.section}>
      <div className={styles.title}>
        <TransitionUp item={<Trans i18nKey="about:strongPoint3Title" />} />
      </div>
      <div className={styles.desc}>
        <TransitionUp item={<Trans i18nKey="about:strongPoint3DescMobile" />} />
      </div>
      <div className={styles.logoContainer}>
        <TransitionImage
          item={<Img fixed={data.mobileMobile.childImageSharp.fixed} />}
        />
      </div>
    </div>
  </Container320>
  ...
  >
    <Container320 className={styles.featureContentContainer}>
      ...
      <div className={styles.featureDesc}>
        <TransitionUp
          item={<Trans i18nKey="about:otherFeaturesDescMobile" />}
        />
      </div>
      <FeatureRow
