  ...
  >
    <Container1024 className={styles.topContentContainer}>
      ...
      <div className={styles.topRightContainer}>
        <TransitionImage
          item={<Img fixed={data.topLogo.childImageSharp.fixed} />}
        />
      </div>
    </Container1024>
  </BackgroundImage>
  ...
  <div className={styles.strongPointContainer}>
    <Container1024 className={styles.section}>
      ...
      <div>
        ...
        <div className={styles.desc}>
          <TransitionUp item={<Trans i18nKey="about:strongPoint1Desc" />} />
        </div>
      </div>
    </Container1024>
    ...
    <Container1024 className={styles.section}>
      <div className={`${styles.left48} ${styles.pl10}`}>
        <Padding y={253} />
        <span className={styles.title}>
          <TransitionUp item={<Trans i18nKey="about:strongPoint2Title" />} />
        </span>
        <div className={styles.desc}>
          <TransitionUp item={<Trans i18nKey="about:strongPoint2Desc" />} />
        </div>
      </div>
    ...
    <Container1024 className={styles.section}>
      ...
      <div>
        ...
        <div className={styles.desc}>
          <TransitionUp item={<Trans i18nKey="about:strongPoint3Desc" />} />
        </div>
      </div>
    </Container1024>
  </div>
  ...
  >
    <Container1024 className={styles.featureContentContainer}>
      ...
      <div className={styles.featureDesc}>
        <TransitionUp item={<Trans i18nKey="about:otherFeaturesDesc" />} />
      </div>
      <FeatureRow
