  ...
  >
    <Container1024 className={styles.topContentContainer}>
      ...
      <div className={styles.topRightContainer}>
        <TransitionImage
          item={<Img fixed={data.homeTopRight.childImageSharp.fixed} />}
        />
      </div>
    </Container1024>
  </BackgroundImage>
  ...
  >
    <Container1024 className={styles.keyFeatureContentContainer}>
      <div className={styles.keyFeatureLeftContainer}>
        <TransitionUp item={<img src={icon} alt={iconAlt} />} />
        <Padding y={20} />
        <TransitionUp
          item={<div className={styles.keyFeatureLeftTitle}>{title}</div>}
        />
        <Padding y={35} />
        <TransitionUp
          item={<div className={styles.keyFeatureLeftDescription}>{desc}</div>}
        />
        <Padding y={40} />
        <TransitionUp
          item={<div className={styles.keyFeatureLeftSubTitle}>{subTitle}</div>}
        />
        <TransitionUp
          item={<div className={styles.keyFeatureLeftSubDesc}>{subDesc}</div>}
        />
        <Padding y={20} />
  ...
  return (
    <div className={styles.featuresContainer}>
      <div className={styles.featuresTitle}>
        <TransitionUp item={<Trans i18nKey="index:featuresTitle" />} />
      </div>
      <Padding y={80} />
