...
const Menu = () => (
  <Container1024 className={styles.menuContainer}>
    <MenuItem
      to={`#${FeatureExpiry.name}`}
      icon={iconMenuExpiry}
      label="유통기한 관리"
    />
    <MenuItem
      to={`#${FeatureLowstock.name}`}
      icon={iconMenuEmpty}
      label="안전재고"
    />
    <MenuItem
      to={`#${FeatureBarcodelabel.name}`}
      icon={iconMenuCustomization}
      label={<>바코드<br/>커스터마이징</>}
    />
    <MenuItem
      to={`#${FeatureSummary.name}`}
      icon={iconMenuSummary}
      label="입출고 요약"
    />
    <MenuItem
      to={`#${FeatureStatus.name}`}
      icon={iconMenuStatus}
      label="상태 관리"
    />
    <MenuItem
      to={`#${FeatureLocation.name}`}
...
function FeatureExpiry(props) {
  return (
    <FeatureTemplate
      id={FeatureExpiry.name}
      bgColor={bgOrange}
      title="유통기한 관리"
...
function FeatureLowstock(props) {
  return (
    <FeatureTemplate
      id={FeatureLowstock.name}
      bgColor={bgGreen}
      title="안전재고"
...
function FeatureBarcodelabel(props) {
  return (
    <FeatureTemplate
      id={FeatureBarcodelabel.name}
      bgColor={bgBlue}
      title="바코드 커스터마이징"
...
function FeatureLocation(props) {
  return (
    <FeatureTemplate
      id={FeatureLocation.name}
      bgColor={bgBlue}
      title="위치 관리"
